...
* Changes
  ...
  + 2011-01-06 :: (kosack) added more information about instrument
                  response matrices
  + 2011-01-15 :: (kosack) added ~OBS_ID~ to the event-list to allow
...
*** External pointing table
    ...
    *This section is a work in progress*
    ...
    generate this table from the header information in each
    observation's event list (and vice-versa), therefore supporting
    both methods of storing the pointing information.
