#+Title:     FITS Data format for ACTs v1.0.0
#+DATE:      2011-05-18
...
##    +LaTeX_CLASS: org-ctadoc

* TODO:
  - add peak time to image info 
  - add spectrum slope to MCENERGY
...
** <<Version Headers>>
   ...
   | Keyword  | type   | standard | comment / unit                       |
   |----------+--------+----------+--------------------------------------|
   | ORIGIN   | string | XMM      | the processing site                  |
   | FILENAME | string | XMM      | name of file (original)              |
   | CREATOR  | string | XMM      | system generating the file + version |
...
*** Base Shower Parameters
   ...
   | ~TELMASK~    | bitmask |          | bit pattern of telescopes used in this event |
   |--------------+---------+----------+----------------------------------------------|
